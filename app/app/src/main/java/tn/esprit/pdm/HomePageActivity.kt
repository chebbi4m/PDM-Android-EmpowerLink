...
class HomePageActivity : AppCompatActivity() {
    ...
    private fun refreshListView() {
        thread {
            val apiResponse = fetchDataFromApi("http://10.0.2.2:9090/experience/getAllExperiencesByDate/")
    ...
    private fun parseApiResponse(apiResponse: String): List<Experience> {
        ...
        try {
            ...
            for (i in 0 until experiencesArray.length()) {
                ...
                experiences.add(Experience(id, communityId, image, title, category, username, experienceDate, experienceText))
            }
